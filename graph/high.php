...
//	  console.log((o.match).length);
if($.isArray(o.match)){
		console.log(o.match[0].place.centroid.latitude,o.match[0].place.centroid.longitude);
		}
else if(!$.isArray(o.match)){
	   latitude=o.match.place.centroid.latitude, longitude=o.match.place.centroid.longitude; 
	   console.log(latitude,longitude);
}
else if(!$.isArray(o.match) &&(o.match==null)){
   latitude="", longitude=""; 
...
//setMarker(screen_name,contentString,img,text,profile_img,url);
});//console.log(array);
});
...
<body><input type="button" value="Get" onclick="codeAddress();"></div>

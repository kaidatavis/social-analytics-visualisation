...
//        sV = new Scrollbar(Scrollbar.VERTICAL, 0, 0, 0, 255);
//        add(sV);
//        
//        sH = new Scrollbar(Scrollbar.HORIZONTAL, 0, 0, 0, 255);
//        add(sH);
    }
    ...
    public void setup() {       
         size(850, 260);
       // img = loadImage("C:/Users/Nantia/Pictures/mypic1.jpg");
        noLoop();
         frameRate(60);
//         loop();
    }
        ...
        for (i=0; i<col1.length; i++){
            if (color(0,0,col1[i]) == get(mouseX,mouseY)){
                ...
                if(myGraphs.length == 12){
                    ...
                    myDay = 0;
                    myHour = 0;
//                    myList myList1 = new myList(tweetList, mPoints, Prototype3View.jcombo);
                } else if(myGraphs.length == 31){
                    myDay = getDay(mouseX);
                    myMonth = 0;
                    myHour = 0;

...
//	Vectors vectorObj = new Vectors();
	...
	public Lombardi()
	{
		...
		progressLabel = new JLabel("Generating graph please wat...");
		 progressBar = new JProgressBar();
        
       //  progressBar.setSize(600, 400);
         
       // progressBar.setLocation(1,1);
		...
		shuffleSamples = 500;	//#max number of shuffle attempts
		modeLombardi = true;
		...
		padding = 20;	//#some padding for the screen
			...
			if(global_i <= maxIters)
			{
				...
				//	ArrayList<Vectors> bezierReturn = Classes.bezier(start_vectors,startCtrl_vectors,endCtrl_vectors,end_vectors);
					...
					Shape bezier =  new CubicCurve2D.Float(start_vectors.x, start_vectors.y,
							startCtrl_vectors.x , startCtrl_vectors.y, endCtrl_vectors.x, endCtrl_vectors.y
							,end_vectors.x, end_vectors.y);
...
//				maxIters++;
	...
	//	Lombardi obj= new Lombardi();
		 ...
		 JFrame f = new JFrame("ShapesDemo2D");
			...
			pictureScrollPane.setPreferredSize(new Dimension(800, 800));
...
//			setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));		    
		    ...
		    f.setContentPane(pictureScrollPane);
		...
		LombardiContentPane
				.setFileName("C:\\EclipseWorkspace\\Phase1\\src\\Project_Phase1\\triGraph.dot");
		LombardiContentPane.setjFrameRef(f);
		...
		f.setTitle("Total Time Taken " + disHour + ":" + disMinu + ":" + disSec + " Total Nodes = " + LombardiContentPane.totalNodes
				+ " Total Edges = " + LombardiContentPane.totalEdges) ; 
